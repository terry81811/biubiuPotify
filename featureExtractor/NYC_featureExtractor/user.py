...
f_biz = io.open('../output/NYC/restaurant_features_nyc.tsv', 'r', encoding='utf8')
f_user = io.open('../input/NYC/user_id_mapping_all_nyc.tsv', 'r', encoding='utf8')
f_reviews = io.open('../output/NYC/review_features_nyc.tsv', 'r', encoding='utf8')
...
f_out = io.open('../output/NYC/user_features_nyc.tsv', 'w', encoding='utf8')
